...
export const DSProperties = Map({ dsname: 'ATLAS.TEST', blockSize: 0, primary: 300, recordLength: 80, secondary: 100, dirblk: 20, dataSetOrganization: 'PO', recordFormat: 'FB', allocationUnit: 'TRACK' });
